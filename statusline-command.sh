...
# --- Per-icon overrides ---
# Any individual icon can be replaced via STATUSLINE_ICON_<NAME> env vars,
# independent of the STATUSLINE_ICONS mode. Useful to e.g. keep the default
# ascii set but swap just the git branch icon for a Nerd Font one:
#
#     export STATUSLINE_ICON_GIT=󰘬
#
ICON_MODEL="${STATUSLINE_ICON_MODEL:-$ICON_MODEL}"
ICON_CTX="${STATUSLINE_ICON_CTX:-$ICON_CTX}"
ICON_DIR="${STATUSLINE_ICON_DIR:-$ICON_DIR}"
ICON_GIT="${STATUSLINE_ICON_GIT:-$ICON_GIT}"
ICON_COST="${STATUSLINE_ICON_COST:-$ICON_COST}"
ICON_WARN="${STATUSLINE_ICON_WARN:-$ICON_WARN}"
ICON_VIM="${STATUSLINE_ICON_VIM:-$ICON_VIM}"
ICON_NODE="${STATUSLINE_ICON_NODE:-$ICON_NODE}"
ICON_CLOCK="${STATUSLINE_ICON_CLOCK:-$ICON_CLOCK}"
ICON_CODE="${STATUSLINE_ICON_CODE:-$ICON_CODE}"
ICON_AGENT="${STATUSLINE_ICON_AGENT:-$ICON_AGENT}"
ICON_TREE="${STATUSLINE_ICON_TREE:-$ICON_TREE}"
